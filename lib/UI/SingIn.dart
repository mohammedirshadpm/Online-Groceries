...
class _LoginState extends State<Login> {
  @override
  void initState() {
    BlocProvider.of<SingInBloc>(context).add(FetchSingInEvent(
        password: password.text.trimRight(), email: email.text.trimRight()));
    super.initState();
  }
                ...
                child: BlocListener<SingInBloc, SingInState>(
                  listener: (context, state) {
                    ...
                    if (state is SingInblocLoaded) {
                      data = BlocProvider.of<SingInBloc>(context).singInModel;
                      Navigator.of(context).pop();
